    ...
    <section className="mb-32">
      ...
      >
        <iframe
          ...
          allowFullScreen
          loading="lazy"
          title="Google Map - Golden Gate Bridge"
        ></iframe>
      </div>
            ...
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
              <form>
                ...
                <div className="mb-6 inline-block min-h-[1.5rem] justify-center pl-[1.5rem] md:flex">
                  <input
                    className="relative float-left mt-[0.15rem] mr-[6px] -ml-[1.5rem] h-[1.125rem] w-[1.125rem] appearance-none rounded-[0.25rem] border-[0.125rem] border-solid border-neutral-300 outline-none checked:border-primary checked:bg-primary hover:cursor-pointer focus:shadow-none focus:transition-[border-color_0.2s]"
                    type="checkbox"
                    id="exampleCheck96"
                    defaultChecked
                  />
